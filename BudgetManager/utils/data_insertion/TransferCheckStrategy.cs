...
namespace BudgetManager.non_mvc {
    class TransferCheckStrategy : DataInsertionCheckStrategy {
        ...
        private int checkAvailableBalance(QueryData inputData, double transferValue) {
            ...
            try {
                ...
                accountBalanceOutput = new MySqlParameter("p_account_balance", MySqlDbType.Double);
